...
## Task
 The task is to perform a complete data science workflow, like loading, summarizing, visualizing and modelling the dataset, in a clean and reproducible way.

## Description
Here, we load the Iris Dataset using pandas.
- Summarizing its dimensions, data samples, statistics, and class distribution.
- Visualizing data with univariate(histogram) and multivariate(scatter matrix) plots using matplotlib.
- Training and evaluating six machine learning models (DecisionTree, GaussianNB, KNeighbors, LogisticRegression, LinearDiscriminant, SVM) using scikit-learn, reporting their average accuracies 

## Installation
The program is coded in python and executed in Jupyter notebook. used various modules like pandas, matplotlib and scikit-learn
